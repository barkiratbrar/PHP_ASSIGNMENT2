...
<body>
  ...
  <?php
	...
	<section class="head">
		<div class="image-bg" style="position:absolute;">
			<img src="images/background.avif" alt="" style="height:1200px;">
		</div>
		<div>
			<h1>DATA Portal</h1>
		</div>
  ...
  <main class="container" style="position:relative;">
	   <section class="form-row row justify-content-center">
		     <form method="post" class="form-horizontal col-md-6 col-md-offset-3" action="save-admin.php" style="background-color:#ffae00;">
					 <h2>Create User</h2>
					...
					<div class="form-group">
						...
						<input class="btn btn-primary col-md-2 col-md-offset-10" type="submit" value="Register" style="background-color:white;color:black;">
					</div>
</form>
